...
# usage = "Usage: <COUNTS_FILE> <SAMPLE_FILE> <OUT_DIR> <EDGER_BCV> <CONTRAST_FILE> <TPM_file> <AnnotationFile|none>\n"
...
counts_file <- "C:/Users/s167561/OneDrive/Documents/Bioinformatics_pipelines/Differential_gene_expression/igenomes.genes.tab"
groups_file <- "C:/Users/s167561/OneDrive/Documents/Bioinformatics_pipelines/Differential_gene_expression/SampleInfo.txt"
root_output_dir <- "C:/Users/s167561/OneDrive/Documents/Bioinformatics_pipelines/Differential_gene_expression"
edgeR_bcv <- 2
contrast_file <- "C:/Users/s167561/OneDrive/Documents/Bioinformatics_pipelines/Differential_gene_expression/ContrastInfo.txt"
...
root_output_dir
edgeR_bcv
# file_path_sans_ext is from tools package
...
# keep only genes with non-zero cpm in at least one sample. Remove genes with all-zero cpms.
keep <- rowSums(cpm(counts)>0) >= 1  
...
# Name the first row as the row name
...
# important to set stringsAsFactors=FALSE
contrast_df <- read.delim(contrast_file, sep=",", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
contrast_df

# The stop() function in R is used to terminate the execution of a script or function and 
# throw an error message when a specific condition is met
